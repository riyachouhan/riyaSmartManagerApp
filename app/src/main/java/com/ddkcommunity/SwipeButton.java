...
//        addView(swipeButton, layoutParamsButton);
        ...
        disabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_slider_icon);
        enabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_slider_icon);
